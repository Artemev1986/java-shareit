...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findAllByUserId(long userId, State state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findAllByOwnerId(long userId, State state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
